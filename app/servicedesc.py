class services:
  serviceDict = {
        ...
        "Barrington landscaping": """Wurk Services is run by local students who know the Barrington and Chicago land area. <br></br>
          ...
          We service properties in the Chicagoland area every week, that allows us to keep your lawn green, healthy, and free of weeds. Our grass cutting service includes cutting the lawn, edging, trimming, and blowing.<br></br>
...
<li class="list-group-item">Fertilizing</li>
        ...
        "Fall Services Meta":"",
        "Junk Removal Services": '''Wurk is a leading junk removal service, specializing in removing junk and clutter of all kinds. Contact us today to get your junk removed! Wurk Junk Removal Services can save you money over dumpster rentals, by charging you only for how much you need to be removed!. <br></br>
...
<br>
Our math courses are available for all topics like algebra (simple and advanced), geometry, calculus, and any other topic that you need help in. Tutors need to be compensated for their time since we work hard to make sure that every child that works with us, has the best chance of succeeding with us. Please fill out the form below to get a pricing structure from us on how much it costs for your particular topic, and your particular times. ''',
...
<br>
We work hard to make sure that our students excel at every subject and task, so tutors are compensated appropriately based on the needs of the student, and timings. Fill out the form below to see your rate and our expertise. ''',
